 ...
 */
export interface EndpointMetadataInterface<CoreReqSchema extends Schema<any, any>, Result> {
    readonly name: string;
    readonly group: string;
    readonly requestSchema: RequestSchemaInterface<CoreReqSchema>;
    readonly call: (client: any, mappedRequest: SchemaType<CoreReqSchema>) => Promise<ApiResponse<Result>>;
...
export interface RequestSchemaInterface<CoreReqSchema extends Schema<any, any>> {
    ...
    validateAndMap(args: SchemaMappedType<CoreReqSchema>): ValidationResult<SchemaType<CoreReqSchema>>;
}
/**
...
//# sourceMappingURL=endpointMetadataFromId.d.ts.map