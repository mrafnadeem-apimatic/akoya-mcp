 ...
 */
export function httpMcpServer(serverName, port, server) {
    const app = express();
    app.use(cors());
 ...
 * @param server MCP Server instance
 */
function mapEndpoints(app, server, transports) {
    // =============================================================================
 ...
 * @param server MCP Server instance
 */
async function handleStatefulMCPRequest(sessionId, transports, req, res, server) {
 ...
 * @param server MCP Server instance
 */
async function handleStatelessMCPRequest(req, res, server) {
