...
import {
  ...
  gainOrLossFromCryptocurrencyTransactionSchema,
} from './gainOrLossFromCryptocurrencyTransaction.js';
...
export interface CryptocurrencyTaxStatementList {
...
export const cryptocurrencyTaxStatementListSchema: Schema<CryptocurrencyTaxStatementList> = typedExpandoObject(
  {
    ...
    gainsAndLosses: [
      'gainsAndLosses',
      optional(
        array(lazy(() => gainOrLossFromCryptocurrencyTransactionSchema))
      ),
    ],
  },
