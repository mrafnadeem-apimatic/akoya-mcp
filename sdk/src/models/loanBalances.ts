...
import {
  CompoundingPeriod,
  compoundingPeriodSchema,
} from './compoundingPeriod.js';
...
import {
  ...
  loanAccountPaymentFrequencySchema,
} from './loanAccountPaymentFrequency.js';
...
export interface LoanBalances {
  ...
  paymentFrequency?: LoanAccountPaymentFrequency;
...
export const loanBalancesSchema: Schema<LoanBalances> = typedExpandoObject(
  {
    ...
    compoundingPeriod: ['compoundingPeriod', optional(compoundingPeriodSchema)],
    ...
    paymentFrequency: [
      'paymentFrequency',
      optional(loanAccountPaymentFrequencySchema),
    ],
    ...
    interestPaidYearToDate: ['interestPaidYearToDate', optional(number())],
    ...
    originalPrincipal: ['originalPrincipal', optional(number())],
