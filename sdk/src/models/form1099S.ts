...
export const form1099SSchema: Schema<Form1099S> = typedExpandoObject(
  {
    ...
    dateOfClosing: ['dateOfClosing', optional(string())],
    ...
    foreignPerson: ['foreignPerson', optional(boolean())],
    realEstateTax: ['realEstateTax', optional(number())],
  },
