...
export interface Form1098Ma {
  ...
  mortgageAssistancePayments?: number;
  /** Box 3, Homeowner mortgage payments */
  homeownerMortgagePayments?: number;
  additionalProperties?: Record<string, unknown>;
}

export const form1098MaSchema: Schema<Form1098Ma> = typedExpandoObject(
  {
    ...
    totalMortgagePayments: ['totalMortgagePayments', optional(number())],
