...
} from './healthInsuranceMarketplaceCoveredIndividual.js';
import {
  OfferOfHealthInsuranceCoverage,
  offerOfHealthInsuranceCoverageSchema,
} from './offerOfHealthInsuranceCoverage.js';
import {
  TaxFormAttribute,
...
export const form1095CSchema: Schema<Form1095C> = typedExpandoObject(
  {
