...
export const form1099QaSchema: Schema<Form1099Qa> = typedExpandoObject(
  {
    ...
    programTransfer: ['programTransfer', optional(boolean())],
    terminated: ['terminated', optional(boolean())],
    notBeneficiary: ['notBeneficiary', optional(boolean())],
  },
