...
import {
  NameAddressAndPhone,
  nameAddressAndPhoneSchema,
} from './nameAddressAndPhone.js';
import {
  TaxFormAttribute,
...
export interface Form1099Sb {
  ...
  contactNameAddress?: NameAddressAndPhone;
  additionalProperties?: Record<string, unknown>;
}

export const form1099SbSchema: Schema<Form1099Sb> = typedExpandoObject(
  {
    ...
    contractInvestment: ['contractInvestment', optional(number())],
    surrenderAmount: ['surrenderAmount', optional(number())],
    contactNameAddress: [
      'contactNameAddress',
      optional(lazy(() => nameAddressAndPhoneSchema)),
    ],
  },
