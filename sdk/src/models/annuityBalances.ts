...
import {
  AnnualIncreaseType,
  annualIncreaseTypeSchema,
} from './annualIncreaseType.js';
import {
  AnnuityAccountPaymentFrequency,
  annuityAccountPaymentFrequencySchema,
} from './annuityAccountPaymentFrequency.js';
import {
  AnnunityProductType,
  annunityProductTypeSchema,
} from './annunityProductType.js';
import {
  AnnunityValueBasis,
  annunityValueBasisSchema,
} from './annunityValueBasis.js';
...
import {
  ...
  periodCertainGuaranteeSchema,
} from './periodCertainGuarantee.js';

/** Data elements included with balances specific to annuity accounts */
export interface AnnuityBalances {
  ...
  paymentFrequency?: AnnuityAccountPaymentFrequency;
...
export const annuityBalancesSchema: Schema<AnnuityBalances> = typedExpandoObject(
  {
    ...
    annuityProductType: [
      'annuityProductType',
      optional(annunityProductTypeSchema),
    ],
    annuityValueBasis: [
      'annuityValueBasis',
      optional(annunityValueBasisSchema),
    ],
    paymentFrequency: [
      'paymentFrequency',
      optional(annuityAccountPaymentFrequencySchema),
    ],
    annualIncrease: ['annualIncrease', optional(number())],
    annualIncreaseType: [
      'annualIncreaseType',
      optional(annualIncreaseTypeSchema),
    ],
    netPresentValue: ['netPresentValue', optional(number())],
    paymentAmount: ['paymentAmount', optional(number())],
    paymentEndDate: ['paymentEndDate', optional(string())],
    paymentStartDate: ['paymentStartDate', optional(string())],
    periodCertainGuarantee: [
      'periodCertainGuarantee',
      optional(periodCertainGuaranteeSchema),
    ],
    totalPaymentCount: ['totalPaymentCount', optional(number())],
  },
