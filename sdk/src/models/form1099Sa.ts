...
export const form1099SaSchema: Schema<Form1099Sa> = typedExpandoObject(
  {
    ...
    distributionCode: ['distributionCode', optional(string())],
    fairMarketValue: ['fairMarketValue', optional(number())],
    hsa: ['hsa', optional(boolean())],
    archerAccount: ['archerAccount', optional(boolean())],
    medicalSavingsAccount: ['medicalSavingsAccount', optional(boolean())],
  },
