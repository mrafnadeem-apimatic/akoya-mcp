...
import { AccountCategory, accountCategorySchema } from './accountCategory.js';
import {
  AccountInfoStatus,
...
import {
  PolicyPremiumTerm,
  policyPremiumTermSchema,
} from './policyPremiumTerm.js';

/** Data elements included with balances specific to insurance accounts */
export interface InsuranceBalances {
...
export const insuranceBalancesSchema: Schema<InsuranceBalances> = typedExpandoObject(
  {
    ...
    accountCategory: ['accountCategory', optional(accountCategorySchema)],
    policyCoverageAmount: ['policyCoverageAmount', optional(number())],
    policyEndDate: ['policyEndDate', optional(string())],
    policyPremium: ['policyPremium', optional(number())],
    policyPremiumTerm: ['policyPremiumTerm', optional(policyPremiumTermSchema)],
