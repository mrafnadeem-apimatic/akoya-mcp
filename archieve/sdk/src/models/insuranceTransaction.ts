...
import {
  ...
  insuranceTransactionTypeSchema,
} from './insuranceTransactionType.js';
...
export const insuranceTransactionSchema: Schema<InsuranceTransaction> = typedExpandoObject(
  {
    ...
    transactionType: [
      'transactionType',
      optional(insuranceTransactionTypeSchema),
    ],
  },
