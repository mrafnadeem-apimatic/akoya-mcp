...
import {
  LocTransactionType,
  locTransactionTypeSchema,
} from './locTransactionType.js';
import { PaymentDetails, paymentDetailsSchema } from './paymentDetails.js';
import {
  TransationStatus,
...
export const locTransactionSchema: Schema<LocTransaction> = typedExpandoObject(
  {
    ...
    transactionType: ['transactionType', optional(locTransactionTypeSchema)],
  },
