...
export const loanTransactionSchema: Schema<LoanTransaction> = typedExpandoObject(
  {
    ...
    transactionType: ['transactionType', optional(loanTransactionTypeSchema)],
  },
