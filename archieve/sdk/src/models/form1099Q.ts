...
export const form1099QSchema: Schema<Form1099Q> = typedExpandoObject(
  {
    ...
    earnings: ['earnings', optional(number())],
    basis: ['basis', optional(number())],
    trusteeToTrustee: ['trusteeToTrustee', optional(boolean())],
    tuitionPlanPrivate: ['tuitionPlanPrivate', optional(boolean())],
    tuitionPlanPublic: ['tuitionPlanPublic', optional(boolean())],
    coverdellEsa: ['coverdellEsa', optional(boolean())],
