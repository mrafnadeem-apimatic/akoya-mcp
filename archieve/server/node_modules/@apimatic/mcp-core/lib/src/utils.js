...
export async function createErrorMessage(error) {
    ...
    if (statusCode !== null && body !== null && headers !== null) {
        ...
        if (body instanceof Readable) {
            body = await streamToString(body);
        }
        const errorObj = {
            statusCode,
            headers,
 ...
 */
export function getToolName(endpointId) {
    if (!endpointId) {
